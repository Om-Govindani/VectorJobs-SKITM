  ...
  return (
    <>
      ...
      <Navbar userInfo={userInfo}/>
        ...
        <div className="w-2/3 h-full px-12 py-8 flex flex-col justify-center bg-[#7E8EF1]">
          <div className="flex justify-around items-center mb-8">
            <h2 className="text-white text-3xl font-bold">Client Profile</h2>
            <button
              type="button"
          ...
          <div className="space-y-4 mx-2 my-2">
            <div className="bg-white text-gray-800 p-4 rounded-lg shadow-lg shadow-gray-300 flex items-center transition-transform duration-300 ease-in-out hover:bg-gradient-to-r hover:from-blue-100 hover:to-blue-200 hover:border-blue-400 hover:border-2 border hover:scale-105 hover:shadow-2xl">
            ...
            <div className="bg-white text-gray-800 p-4 rounded-lg shadow-lg shadow-gray-300 flex items-center transition-transform duration-300 ease-in-out hover:bg-gradient-to-r hover:from-yellow-100 hover:to-yellow-200 hover:border-yellow-400 hover:border-2 border hover:scale-105 hover:shadow-2xl">
              <FaRegFileAlt className="w-6 h-6 text-yellow-600 mr-4" />
              <div className="flex flex-grow flex-col">
                <div className="flex items-center space-x-2">
                  <p className="font-semibold text-lg">Description:</p>
                  <p className="text-md text-gray-700">{userInfo ? userInfo.description : profile.description}</p>
                </div>
              </div>
            </div>
          </div>
